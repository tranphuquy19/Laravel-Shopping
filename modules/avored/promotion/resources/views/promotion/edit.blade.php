    ...
    <div class="row" id="promotion-save-accordion" data-children=".promotion-card">
        <div class="col-12">
            <div class="card promotion-card  mb-2 mt-2">
                <a data-toggle="collapse" data-parent="#promotion-save-accordion" class="float-right" href="#basic">
            ...
            <div class="card promotion-card mb-2 mt-2">
                <a data-toggle="collapse" data-parent="#promotion-save-accordion" class="float-right" href="#rules">
                    <div class="card-header">
                        Quy tắc
                    </div>
                </a>
