    ...
    <div class="container">
        ...
        <ul class="navbar-nav">
            ...
            @auth()
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="#">Chào mừng {{ Auth::user()->full_name }} !
                        <span class="sr-only">(current)</span>
                    </a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link" href="{{ route('my-account.home') }}">Tài khoản của tôi
                        <span class="sr-only">(current)</span>
                    </a>
                </li>
            ...
            <div class="col-md-6">
                <a class="navbar-brand" href="{{ route('home') }}">
                    <span style="font-size: 32px; font-weight: 500; margin-top: 10px;">
                        <img src="{{ asset('vendor/avored-default/images/logo.svg') }}" alt="logo" class="logo">ChipChipWatch Store
                    </span>
                </a>
            </div>
            <div class="col-md-6">
